...
def parse_arm_template(template_path):
...
def main():
    arm_template_path = "path/to/your/template.json"  # Update this path
    readme_path = "README.md"

    template = parse_arm_template(arm_template_path)
    markdown_content = generate_markdown(template)
